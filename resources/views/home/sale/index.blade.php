        ...
        <div class="col-12">
            <div class="card shadow-lg border-0">
                <div class="card-header bg-gradient-secondary text-white ">
                    <h4 class="mb-0 text-white">Sale Data</h4>
                    <button type="button" class="btn btn-sm btn-white text-primary" data-bs-toggle="modal"
                        data-bs-target="#exampleModal">
                        + Add Data
                    </button>
                    <a href="/sale/report" class="btn btn-success btn-sm">Report Monthly</a>
                    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                        aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header bg-gradient-secondary">
                                    <h1 class="modal-title fs-5 text-white" id="exampleModalLabel">Add Sale Data
                                    </h1>
                                ...
                                <div class="modal-body">
                                    <form action="/sale/store" method="post">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input name="customer_name" id="" class="form-control"
                                                value="{{ old('customer_name') }}"></input>
                                            @error('customer_name')
