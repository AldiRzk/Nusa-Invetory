...
<body onload="printAndclose()">
    ...
    <div class="info">
        <p><strong>Tanggal:</strong> {{ \Carbon\Carbon::parse($purchase->date)->format('d/m/Y H:i') }}</p>
    ...
    <div class="total">
        <p><strong>Total:</strong> <span class="right">Rp{{ number_format($purchase->total_amounts, 0, ',', '.') }}</span></p>
    </div>
